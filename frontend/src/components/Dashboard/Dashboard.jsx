...
export default function Dashboard(){
  ...
  useEffect(()=>{
    if(timer===0){
        ...
        console.log(selectedColour,betValue);
        
        // check winner
        if(selectedColour && betValue){
          if(selectedColour==colour){
            console.log("you won" , "selected colur and bet value is" ,selectedColour,betValue )
            ...
            console.log("you lost and your selected colour and bet amount is ",selectedColour,betValue );
          }
        }
        ;
  ...
  function handelSelectedColorValue(value){
    ...
    return(
        ...
        <Game timer={timer} onBetValueChange = {handelBetValue} onColorValueChange = {handelSelectedColorValue} availBalance={availBalance} setAvailBalance = {setAvailBalance}/>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div className="w-96 bg-gradient-to-b from-orange-400 to-orange-200 p-6 rounded-lg shadow-lg">
      ...
      <div className="relative flex items-center justify-center mb-4">
        <h2 className="text-2xl font-bold text-center text-white">Congratulation</h2>
        <button
      ...
      {/* Winning Amount */}
      <p className="text-center text-3xl font-bold text-green-600 mb-2">{winAmt}</p>
